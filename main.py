...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='200513_HKC_7th', help='path of the dataset') # 200411_HKC_3rd
...
parser.add_argument('--load_size', dest='load_size', type=int, default=384, help='scale images to this size') # default=286 # 143, 128
parser.add_argument('--fine_size', dest='fine_size', type=int, default=256, help='then crop to this size')
parser.add_argument('--ngf', dest='ngf', type=int, default=32, help='# of gen filters in first conv layer') # default=64
parser.add_argument('--ndf', dest='ndf', type=int, default=32, help='# of discri filters in first conv layer') # default=64
...
parser.add_argument('--phase', dest='phase', default='train', help='train, test, test_d') # test : generator, test_d : discriminator
