...
def generator_unet128(image, options, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name):
        ...
        d7 = deconv2d(tf.nn.relu(d6), options.output_c_dim, name='g_d8')
...
def generator_resnet(image, options, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name):
        ...
        ### added for 6th_8
        #pred = tf.concat([pred, image], axis=3)
        #pred = conv2d(pred, options.output_c_dim, 7, 1, padding='SAME', name='g_pred_c_o')
        ###
